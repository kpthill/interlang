...
| `concepticon/*.tsv` | [concepticon/concepticon-data](https://github.com/concepticon/concepticon-data) conceptlists | `master`, fetched 2026-08-06 | `uv run python scripts/lexicon_milestone1.py` (fetches three lists on first run; superseded by the full `concepticon-data/` clone below) |
| `ids/` | [intercontinental-dictionary-series/ids](https://github.com/intercontinental-dictionary-series/ids) | `main`/`master` (`3428921`), fetched 2026-08-06 | `git clone --depth 1 https://github.com/intercontinental-dictionary-series/ids data/raw/ids` |
| `concepticon-data/` | [concepticon/concepticon-data](https://github.com/concepticon/concepticon-data) | `main`/`master` (`a0ed32c`), fetched 2026-08-06 | `git clone --depth 1 https://github.com/concepticon/concepticon-data data/raw/concepticon-data` |
| `clics3/` | [clics/clics3](https://github.com/clics/clics3) | `main`/`master` (`19b4051`), fetched 2026-08-06 | `git clone --depth 1 https://github.com/clics/clics3 data/raw/clics3` |
